...
export default function HomepageHero() {
  ...
  return (
    ...
    >
      <div className="h-full flex flex-col lg:flex-row items-center justify-center relative max-w-7xl mx-auto px-4 pb-16 md:pb-0 md:px-8">
        ...
        <div className="order-first lg:order-0 mb-12 lg:mb-0 lg:ml-12 flex justify-center relative z-2">
          <Image
            src="hero-image.svg"
