          ...
          >
            ...
            <div className="flex items-center justify-between max-w-101.5 md:max-w-full w-full lg:px-0">
              ...
              <button
                ...
                className="border border-lightmode dark:border-darkmode py-2 px-4 rounded transition-all duration-300 group-hover:bg-lightmode-secondary dark:group-hover:bg-darkmode-secondary cursor-pointer"
              >
                <svg
                  className="stroke-lightmode dark:stroke-darkmode transition-all duration-300 group-hover:stroke-white"
                  xmlns="http://www.w3.org/2000/svg"
